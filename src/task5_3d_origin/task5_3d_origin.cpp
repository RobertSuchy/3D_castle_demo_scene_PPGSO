...
public:
    ...
    void updateModelMatrix() {
        ...
        modelMatrix = glm::rotate(glm::mat4{1.0f}, rotation.y, glm::vec3{0, 1, 0})
    ...
    void updateViewMatrix(glm::vec3 viewRotation) {
        ...
        viewMatrix = glm::translate(glm::mat4{1.0f}, {0, 0, -30})
                     * glm::rotate(glm::mat4{1.0f}, viewRotation.x, glm::vec3{1, 0, 0})
                     * glm::rotate(glm::mat4{1.0f}, viewRotation.y, glm::vec3{0, 1, 0})
                     * glm::rotate(glm::mat4{1.0f}, viewRotation.z, glm::vec3{0, 0, 1});
    }
